...
export class QmblogSettingTab extends PluginSettingTab {
  ...
  display(): void {
    ...
    // Header
    containerEl.createEl("h1", { text: "yuanle-blog Publisher" });
    containerEl.createEl("p", {
      text: "将 Obsidian 笔记发布到你自己的 yuanle-blog",
    ...
    usageDesc.innerHTML = `
      <ul style="margin: 8px 0; padding-left: 20px; line-height: 1.8;">
        ...
        <li>使用命令面板搜索 <strong>「发布到 yuanle-blog」</strong></li>
        <li>在编辑器中 <strong>右键菜单</strong> 选择发布</li>
        <li>在文件管理器中 <strong>右键文件</strong> 选择发布</li>
        <li>点击底部状态栏 <strong>「yuanle-blog」</strong> 快速发布</li>
      </ul>
    `;
  }
}
