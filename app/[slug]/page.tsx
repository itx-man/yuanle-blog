      ...
      <main className="page-main mx-auto w-full max-w-3xl px-4 sm:px-6 flex-1 py-8 sm:py-12">
        {searchIndexable && (() => {
          ...
          const jsonLd = {
            ...
            description: post.description || '',
            image: ogImage,
            author: { '@type': 'Person', name: 'yuanle-blog', url: 'https://github.com/itx-man' },
            publisher: { '@type': 'Organization', name: 'yuanle-blog', url: baseUrl, logo: { '@type': 'ImageObject', url: `${baseUrl}/icon-512.png` } },
